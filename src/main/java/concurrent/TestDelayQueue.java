...
/**
 * 在现实生活中，很多DelayQueue的例子。就拿上海的世博会来说明，很多国家地区的开馆时间不同。
 * 你很早就来到园区，然后急急忙忙地跑到一些心仪的馆区，发现有些还没开，你吃了闭门羹。
 * 仔细研究DelayQueue，你会发现它其实就是一个PriorityQueue的封装（按照delay时间排序），
 * 里面的元素都实现了Delayed接口，相关操作需要判断延时时间是否到了。
 * 在实际应用中，有人拿它来管理跟实际相关的缓存、session等
 * 下面我就通过 “上海世博会的例子来阐述DelayQueue的用法”
 */
public class TestDelayQueue {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DelayQueue<Stadium> queue = new DelayQueue<>();
