...
public class Stream {
    public static void main(String[] args) {
        ...
        System.out.println("所有数字的个数 : " + stats.getCount());
        System.out.println("所有数字的类 : " + stats.getClass());
        System.out.println("---------------------------------------------");

        Consumer<Person> greeter = (p) -> System.out.println("Hello, " + p.getFirstName());
        greeter.accept(new Person("Luke", "Skywalker", "Java programmer", "male", 43, 2000));
